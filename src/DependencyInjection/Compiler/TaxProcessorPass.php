 ...
 */
class TaxProcessorPass implements CompilerPassInterface
{
    /**
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        $services = $container->findTaggedServiceIds(TaxProcessor::SEMARTHRIS_TAX_PROCESSOR);
        $processors = [];
        foreach ($services as $serviceId => $tags) {
            $processors[] = new Reference($serviceId);
        }

        $container->getDefinition(TaxProcessor::class)->addArgument($processors);
    }
}
