...
{
    public function save(WorkshiftInterface $workshift): void;

    public function findByEmployeeAndDate(EmployeeInterface $employee, \DateTimeInterface $attendanceDate): ?AttendanceInterface;
}
