...
use KejawenLab\Semart\Skeleton\Component\Contract\Company\CompanyLetterRepositoryInterface;
use KejawenLab\Semart\Skeleton\Entity\CompanyLetter;

/**
 * @author Muhamad Surya Iksanudin <surya.iksanudin@gmail.com>
 */
class CompanyLetterRepository extends Repository implements CompanyLetterRepositoryInterface
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, CompanyLetter::class);
    }
