 ...
 */
class OrganizationDepartmentController extends AdminController
{
    /**
     * @Route("/", methods={"GET"}, name="departments_index", options={"expose"=true})
     *
     * @Permission(actions=Permission::VIEW)
     */
    public function index()
    {
        return $this->redirectToRoute('organizations_index', ['l' => OrganizationInterface::LEVEL_DEPARTMENT]);
    }
}
